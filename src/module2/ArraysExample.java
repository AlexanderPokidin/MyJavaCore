...
public class ArraysExample {
    ...
    public static void main(String[] args) {
        ...
        int[] balance = {1303, 1232, 900, 432, 5600, 2323, 0, 10};
        int[] balance1 = {1435, 1436, 3460, 436, 5346, 436, 4340, 150};

        int sum = calculateBalancesSum(balance);
        int sum1 = calculateBalancesSum(balance1);
